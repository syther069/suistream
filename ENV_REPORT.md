...
4. `NEXT_PUBLIC_WALRUS_AGGREGATOR` (Client/Server Walrus read/aggregator endpoint)
...
*   `NEXT_PUBLIC_WALRUS_AGGREGATOR` (Configured in `.env.local` as `https://aggregator.walrus.space`)
...
*   `NEXT_PUBLIC_WALRUS_AGGREGATOR`: Correspondingly, the aggregator URL should be `https://aggregator.walrus-testnet.walrus.space`.
